...
summary_price_info = summary_price.text
print(summary_price_info)
item_total = "Item total: " + price_finish_product_1_info
print(item_total)
assert summary_price_info == item_total
print("Total summary price is correct")
